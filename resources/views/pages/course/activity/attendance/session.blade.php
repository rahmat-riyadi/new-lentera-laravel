...
mount(function (Course $course,CourseSection $section, Attendance $attendance){
    ...
    $this->sessions = $this->sessions->map(function($e){
        ...
        $e->date = $date->translatedFormat('l, d F Y');
        $e->start_time = $date->translatedFormat('h:i');
        if($e->duration > 0){
            $e->end_time = \Carbon\Carbon::parse($e->sessdate + $e->duration)->translatedFormat('h:i');
        }
    ...
    <div x-data class="h-full overflow-y-auto relative">
        <div class="bg-white course-page-header px-8 py-8 font-main flex flex-col" >
            ...
            <div class="flex items-center justify-between" >
                ...
                <a href="/teacher/attendance/session/{{ $attendance->id }}/add" class="btn-primary flex items-center">
                ...
                <table class="w-full" >
                    ...
                    <tbody class="table-body" >
                        ...
                        <tr class="" >
                            ...
                            <td class="py-16" >{{ $session->start_time }}</td>
                            <td class="py-16" >
                            ...
                            <td class="py-16 pr-5" >
                                <div class="flex justify-end" >
                                    ...
                                    <a class="btn-light bg-secodary-light text-secodary mx-4" href="">
                                        Edit
                                    </a>
