                ...
                >
                    <div class="grid grid-cols-3 mb-4 gap-x-7" >
                        <label for="passgrade" class="" >
                            ...
                            <input name="passgrade" type="number" id="passgrade" placeholder="Masukkan Nama"  class="text-field">
                            <span class="peer-has-[:focus:invalid]:inline-block hidden text-error text-sm mt-1" >Nilai harus diisi</span>
                        </label>
                        <label for="passgrade" class="" >
                            <span class="block label text-gray-600 text-[12px] mb-1" >Percobaan Menjawab</span>
                            <select name="attempts" class="text-field" >
                ...
                >
                    <div class="grid grid-cols-3" >
                        <div>
                            ...
                            <label for="file_t" class="flex items-center" >
                                <input  x-model="onlinetext" type="checkbox" name="assignsubmission_onlinetext_enabled" class="checkbox w-[18px] h-[18px]" id="file_t">
