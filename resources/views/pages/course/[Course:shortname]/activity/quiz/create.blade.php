...
use function Livewire\Volt\{state, mount, form, on};    
...
on(['changeDescription' => function($val){
    $this->form->fill(['intro' => $val]);
}]);
        ...
        tinymce.init({
            ...
            setup: editor => {
                editor.on('change', e => {
                    ...
                    window.Livewire.dispatch('changeDescription', { val: tinymce.activeEditor.getContent() })
                })
            }
        });
    </script>
