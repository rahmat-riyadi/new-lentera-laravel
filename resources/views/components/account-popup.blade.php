...
<div class="{{ !$show ? 'translate-y-9 invisible -z-50 opacity-0' : 'opacity-100 translate-y-0 visible z-[9999]' }} wrapper absolute bg-white right-8 top-[60px] rounded-lg transition-all duration-300 ease-in-out shadow-lg" >
    <ul class="p-4" >
